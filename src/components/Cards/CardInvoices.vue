<template>
  ...
  >
    ...
    <template #extra >
			<a-button type="primary" class="mb-0">
				VIEW ALL
			</a-button>
		</template>

    <a-list class="invoice-list" item-layout="horizontal" :split="false" :data-source="data">
      <template #renderItem="{ item }">
        <a-list-item>
          ...
          <a-list-item-meta :title="item.title" :description="item.code"></a-list-item-meta>
